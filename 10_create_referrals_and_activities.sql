-- Create referrals table to track real referral data
CREATE TABLE IF NOT EXISTS referrals (
    ...
    reward_amount DECIMAL(10,2) DEFAULT 500.00, -- ₹500 per referral
...
-- Create user_stats table to store calculated statistics
